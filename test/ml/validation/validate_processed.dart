...
void main() {
  group('Validate Professionally Processed CCCD Images', () {
    test('Verify all processed files pass quality checks', () {
      final processedDir = Directory('img_test/processed');
      ...
      print('=== RUNNING AI VALIDATION ON PROFESSIONAL U2-NET PROCESSED IMAGES ===');
